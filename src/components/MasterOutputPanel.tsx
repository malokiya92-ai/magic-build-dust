...
const MasterOutputPanel = ({ gainDb, onChange }: Props) => {
  ...
  return (
    <div className="p-4 panel panel-hover">
      ...
      <div className="flex items-baseline justify-between mb-2">
        ...
        <span className="font-mono text-2xl tabular-nums text-primary text-glow">
      ...
      <div className="mt-3 h-1.5 rounded-full bg-secondary/70 overflow-hidden">
        <div
          ...
          style={{ width: `${pct}%`, background: 'var(--gradient-primary)', boxShadow: '0 0 12px hsl(var(--primary)/0.6)' }}
        />
      </div>
